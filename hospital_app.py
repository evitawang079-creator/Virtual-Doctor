...
st.markdown("""
<!-- COLOR1 -->
<div style="background:linear-gradient(135deg,#f60606 0%,#4fff0a 60%,#0c90dd 100%);
...
with st.form("triage_form"):
    ...
    st.markdown("""
    <!-- COLOR2 -->
    <div style="background:#098bf6;border:1px solid #cbdc0d;border-radius:14px;
        ...
        <div style="display:flex;align-items:center;gap:10px;margin-bottom:4px;">
            ...
            <span style="font-size:16px;font-weight:600;color:#eaecef;">What are your main symptoms?</span>
    ...
    st.markdown("""
    <!-- COLOR3 -->
    <div style="background:#31df0e;border:1px solid #cbdc0d;border-radius:14px;
                padding:20px 24px;margin-bottom:20px;">
        <div style="display:flex;align-items:center;gap:10px;margin-bottom:4px;">
            <span style="background:#050505;color:white;border-radius:8px;
    ...
    <div style="background:#eef609;border:1px solid #cbdc0d;border-radius:14px;
        ...
        <div style="display:flex;align-items:center;gap:10px;margin-bottom:4px;">
            ...
            <span style="font-size:16px;font-weight:600;color:#4f4f4f;">Do you have any of the following?</span>
        </div>
    </div>
    """, unsafe_allow_html=True)
    ...
    st.markdown("""
    <!-- COLOR6 -->
    <div style="background:#f6099b;border:1px solid #cbdc0d;border-radius:14px;
                padding:20px 24px;margin-bottom:20px;">
        <div style="display:flex;align-items:center;gap:10px;margin-bottom:4px;">
            <span style="background:#000000;color:white;border-radius:8px;
...
if submitted:
    ...
    st.markdown("""
    <div style="font-size:22px;font-weight:700;color:#111827;margin-bottom:4px;">Result</div>
    <div style="font-size:14px;color:#6b7280;margin-bottom:1.5rem;">by our Model</div>
    """, unsafe_allow_html=True)
    ...
    with prob_col:
        ...
        st.markdown(bars_html + """
            ...
            <div style="margin-top:20px;background:#e90ee9;border:1px solid #ff0505;
                ...
                <strong>Model:</strong> hospital_model<br>
